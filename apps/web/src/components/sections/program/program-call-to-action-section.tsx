...
export function ProgramCallToActionSection() {
  return (
        ...
        <div className="bg-primary relative overflow-hidden rounded-3xl px-6 py-16 sm:px-12 sm:py-24 md:px-16 lg:px-24">
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            ...
            <p className="text-primary-foreground/80 mx-auto mb-10 max-w-2xl text-lg">
              Don't wait until graduation to figure out your career path. Join the program and take
              control of your professional future.
            </p>
            <div className="flex justify-center">
              <Button
                size="lg"
                variant="secondary"
                className="h-14 w-full px-12 text-base font-bold shadow-xl sm:w-auto"
              >
