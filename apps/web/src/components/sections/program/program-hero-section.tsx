      ...
      <Container className="text-center">
        ...
        >
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg leading-relaxed sm:text-xl">
            A beginner-friendly program designed for IT students to understand the technology
            industry, improve professional skills, and prepare for future career opportunities.
          </p>
